                  ...
                  <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
                     ...
                     <ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
                        <div className="space-y-2">
                           ...
                           <li className="flex gap-1.5 items-center text-left">
                              <CheckIcon className="h-5 w-5 shrink-0 text-green-600" />5 year print
                              guarantee
                           </li>
                           <li className="flex gap-1.5 items-center text-left">
                              <CheckIcon className="h-5 w-5 shrink-0 text-green-600" />
                  ...
                  <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
                     ...
                     <div className="text-lg leading-8">
                        <p>
                           ...
                           Had the case for two and a half months{" "}
                           <span className="p-0.5 bg-slate-800 text-white">
                              the image is super clear.
                           </span>{" "}
                           On the case I had before, the image started fading into yellow-ish color
                  ...
                  <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
                     ...
                     <div className="text-lg leading-8">
                        <p>
                           ...
                           led to some pretty heavy scratch marks in all of my last phone cases.
                           This one, besides a barely noticeably scratch on the corner,{" "}
                           <span className="p-0.5 bg-slate-800 text-white">
                     ...
                     <div className="flex gap-4 mt-2">
                        ...
                        />
                        <div className="flex flex-col">
                           <p className="font-semibold">Gual</p>
                           <div className="flex gap-1.5 items-center text-zinc-600">
                              <CheckIcon className="h-4 w-4 stroke-[3px] text-green-600" />
                              <p className="text-sm">Verified purchase</p>
                           </div>
         ...
         <section>
            <MaxWidthWrapper className="py-24">
               ...
               <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
                  ...
                  <li className="w-fit">
                     <CheckIcon className="h-5 w-5 text-green-600 inline mr-1.5" />5 year print
                     warranty
                  </li>
